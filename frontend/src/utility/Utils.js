...
export const permission_type_option = () => {
  const options = [
    ...
    { id: 2, name: 'Улирлын 70 оноо оруулах хугацаа' },
    { id: 3, name: 'Улирлын 30 оноо оруулах хугацаа' },
    { id: 4, name: 'Давтан шалгалт' },
    { id: 5, name: 'Цахим хичээл байршуулах хугацаа' },
    { id: 6, name: 'Их сургуулийн нэгдсэн төлөвлөлт /шар ном/-д мэдээлэл байршуулах хугацаа' },
    { id: 7, name: 'Шинэ элсэгчдийг элсэлтийн системээс сургалтын системруу татах хугацаа' },
    { id: 8, name: 'Шалгалтын даалгавар оруулах хугацаа' },
    { id: 9, name: 'Шалгалтын хуваарь үүсгэх хугацаа' },
    { id: 10, name: 'Багш багц цагт тооцох мэдээлэл оруулах хугацаа' },
    { id: 11, name: 'Дадлагын оноо байршуулах хугацаа' },
...
export const transliterate = (text) => {
	...
	for (const char of text) {
		result += transliterationMap.get(char) || char;
	}
