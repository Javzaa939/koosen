    ...
    */
	...
	return {
		...
		challenge: {
			...
			getReport: (page=1, limit=10000000, sort='', search='', report_type='', exam='', group='') => instance.get(`learning/challenge/report/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&report_type=${report_type}&exam=${exam}&group=${group}`),
