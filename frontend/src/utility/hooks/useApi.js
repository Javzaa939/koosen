    ...
    */
    ...
    user: {
      get: (limit, page, sort, search) =>
        instance.get(
          `/user/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
        ),
      ...
      refresh_token: (user_id) =>
        instance.post(`/user/token-refresh/${user_id}`),
      new_user_password: (token, data) =>
        instance.post(`/user/new-user-password/${token}`, data),
    ...
    signature: {
      get: (typeNumber, school_id = "") =>
        instance.get(
          `/student/signature/?type=${typeNumber}&school_id=${school_id}`
        ),
      getGraduate: (typeNumber, school_id = "") =>
        instance.get(
          `/student/signature/?type=${typeNumber}&school_id=${school_id}`
        ),
      ...
      changeorder: (data, typeNumber) =>
        instance.post(
          `/student/signature/changeorder/?type=${typeNumber}`,
          data
        ),
    },
    settings: {
      ...
      professionaldegree: {
        ...
        put: (data, pk) =>
          instance.put(`/settings/professionaldegree/${pk}/`, data),
      ...
      studentRegisterType: {
        ...
        put: (data, pk) =>
          instance.put(`/settings/studentregister/${pk}/`, data),
      ...
      lessonCategory: {
        ...
        put: (data, pk) =>
          instance.put(`/settings/lessoncategory/${pk}/`, data),
      ...
      admissionlesson: {
        ...
        put: (data, pk) =>
          instance.put(`/settings/admissionlesson/${pk}/`, data),
      ...
      signature: {
        ...
        getTable: (typeId) =>
          instance.get(`/settings/signature/table/?typeId=${typeId}`),
        changeorder: (data, typeNumber) =>
          instance.post(
            `/settings/signature/changeorder/?type=${typeNumber}`,
            data
          ),
      ...
      permission: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/settings/permission/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
    ...
    study: {
      ...
      lessonStandart: {
        getList: (schoolid, dep_id) => {
          if (dep_id === undefined) dep_id = "";
          if (schoolid === undefined) schoolid = "";
          return instance.get(
            `/learning/lessonstandart/list/?school=${schoolid}&department=${dep_id}`
          );
        },
        ...
        getTimetableList: () => {
          return instance.get(
            `/learning/lessonstandart/timetable-list/?school=${school_id}&lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          );
        },

        getListAll: (profession = "", search = "") =>
          instance.get(
            `/learning/lessonstandart/list/?profession=${profession}&search=${search}`
          ),
        getOneProfessionList: (profession) =>
          instance.get(
            `/learning/lessonstandart/list/profession/${profession}/`
          ),
        get: (limit, page, sort, search, dep_id, category_id) =>
          instance.get(
            `/learning/lessonstandart/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&department=${dep_id}&category=${category_id}&schoolId=${school_id}`
          ),
        post: (data) => instance.post("/learning/lessonstandart/", data),
        put: (data, pk) =>
          instance.put(`/learning/lessonstandart/${pk}/`, data),
        ...
        getStudentLesson: (selected_student) => {
          return instance.get(
            `/learning/lessonstandart/student/list/?student=${selected_student}`
          );
        },
        getStudentDiplomaLessons: (selectedStudent) =>
          instance.get(
            `/learning/lessonstandart/diploma/list/?student=${selectedStudent}`
          ),
        getType: (pk) => instance.get(`/learning/lessonstandart/type/${pk}/`),
        getLessonsGroup: (group) =>
          instance.get(`/learning/lessonstandart/group/${group}/`),

        titleplan: {
          get: (lessonID) =>
            instance.get(`/learning/lessonstandart/titleplan/${lessonID}/`),
          post: (data) =>
            instance.post("/learning/lessonstandart/titleplan/", data),
          put: (data, pk, lessonID) =>
            instance.put(
              `/learning/lessonstandart/titleplan/${lessonID}/${pk}/`,
              data
            ),
          getOne: (lessonID) =>
            instance.get(`/learning/lessonstandart/titleplan/${lessonID}/`),
      ...
      professionDefinition: {
        getList: (degreeId, department, confirm_year) => {
          ...
          return instance.get(
            `/learning/profession/list/?degreeId=${degreeId}&department=${department_id}&confirm_year=${confirm_year_id}&schoolId=${school_id}`
          );
        },
        get: (limit, page, sort, search, degree, department) =>
          instance.get(
            `/learning/profession/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&degree=${degree}&department=${department}&schoolId=${school_id}`
          ),
        post: (data) => instance.post("/learning/profession/", data),
        put: (data, pk) => instance.put(`/learning/profession/${pk}/`, data),
        putIntroduction: (data, pk) =>
          instance.put(`/learning/profession/intro/${pk}/`, data),
        getOne: (pk) => instance.get(`/learning/profession/${pk}/`),
        deleteIntro: (pk) => instance.delete(`/learning/profession/${pk}/`),
        putScore: (data, pk) =>
          instance.put(`/learning/profession/score/${pk}/`, data),
        deleteScore: (pk) =>
          instance.delete(`/learning/profession/score/${pk}/`),
        getAddScoreOne: (pk) =>
          instance.get(`/learning/profession/score/${pk}/`),
        getjustProfession: () =>
          instance.get(
            `/learning/profession/justprofession/?school=${school_id}`
          ),
      ...
      plan: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/learning/plan/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
        search: (salbar, level, type, profession, limit, page, sort, search) =>
          instance.get(
            `/learning/plan/list/${salbar}/${level}/${type}/${profession}/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
        ...
        getPlan: (department, school, profession, level, type) =>
          instance.get(
            `/learning/profession/plan/?department=${department}&school=${school}&profession=${profession}&level=${level}&type=${type}`
          ),
        getPlanFromProfession: (profession) =>
          instance.get(
            `/learning/plan/profession/?profession=${profession}&school=${school_id}`
          ),
        postPlan: (data) => instance.post("/learning/profession/plan/", data),
        deletePlan: (pk) => instance.delete(`/learning/profession/plan/${pk}/`),

        printGetPlan: (department, profession) =>
          instance.get(
            `/learning/profession/print/plan/?department=${department}&profession=${profession}&lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),

        putCopyProfession: (data) =>
          instance.put(`/learning/profession/copy/`, data),
      },
      confirmyear: {
      ...
      lesson: {
        ...
        studentHomeWork: {
          ...
          put: (pk, data) =>
            instance.put(`/learning/lesson/homework/${pk}/`, data),

          multiplePut: (data) =>
            instance.put(`/learning/lesson/assignment/score/`, data),
        },
        ...
        getMaterials: (lessonId, type = "", weekId = "") =>
          instance.get(
            `/learning/lesson/material/${lessonId}/?lesson_type=${type}&week=${weekId}`
          ),

        postSedev: (lessonId, data, type) =>
          instance.post(
            `/learning/lesson/sedev/${lessonId}/?type=${type}`,
            data
          ),
        ...
        postAssignmentMaterial: (lessonId, data) =>
          instance.post(
            `/learning/lesson/material/assignment/${lessonId}/`,
            data
          ),
        ...
        sendMaterial: (lessonId, data) =>
          instance.post(
            `/learning/lesson/material/send-material/${lessonId}/`,
            data
          ),

        getLekts: (lessonId) =>
          instance.get(`/learning/lesson/material/send-material/${lessonId}/`),
        ...
        getApproveMaterial: (
          ...
          instance.get(
            `learning/lesson/approve/?page=${page}&limit=${limit}&type=${type}&sorting=${sort}&search=${search}&teacher=${teacherId}&lesson=${lessonId}`
          ),

        postAnswer: (data) => instance.post(`learning/lesson/approve/`, data),
      },
    },
    /** hrms-ээс */
    hrms: {
      ...
      department: {
        ...
        getSelectSchool: (school) =>
          instance.get(
            `/core/department/?school=${school ? school : school_id}`
          ),

        // тэнхимийн эрхлэгчийн мэдээлэл
        getRegister: (search = "") =>
          instance.get(
            `/core/department/register/?school=${school_id}&search=${search}`
          ),
        getRegisterOne: (pk) =>
          instance.get(`/core/department/register/${pk}/`),
        putRegister: (data, pk) =>
          instance.put(`/core/department/register/${pk}/`, data),
        postRegister: (data) =>
          instance.post(`/core/department/register/`, data),
    ...
    student: {
      ...
      get: (
        ...
        instance.get(
          `/student/info/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&department=${department}&degree=${degree}&profession=${profession}&group=${group}&join_year=${join_year}&schoolId=${school_id}&status=${status}&level=${level}`
        ),
      getDefinition: (limit, page, sort, search) =>
        instance.get(
          `/student/definition/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}`
        ),
      getGraduate1: (
        limit,
        page,
        ...
        instance.get(
          `/student/info/graduate1/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&department=${department}&degree=${degree}&profession=${profession}&group=${group}`
        ),
      getDefinitionLite: (limit, page, sort, search) =>
        instance.get(
          `/student/definition/lite/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}`
        ),
      download: (
        search,
        department,
        ...
        instance.get(
          `/student/info/download/?search=${search}&department=${department}&degree=${degree}&profession=${profession}&group=${group}&join_year=${join_year}&schoolId=${school_id}&status=${status}&level=${level}`
        ),
      getDefinitionStudent: (type, id) =>
        instance.get(`/student/definition/value/?type=${type}&id=${id}`),
      definition: {
        getYear: (code) =>
          instance.get(`/student/definition/season/option/?code=${code}`),
        getSum: (data) => instance.post(`student/definition/sum/`, data),
      },
      getStudentCommandList: () =>
        instance.get(
          `/student/graduate/list/?year=${cyear_name}&season=${cseason_id}`
        ),
      ...
      getList: (state, lesson, teacher, class_id) => {
        ...
        return instance.get(
          `/student/info/list/?state=${state}&lesson=${lesson_id}&teacher=${teacher_id}&class_id=${classId}&school=${school_id}`
        );
      },
      getSimpleList: () => instance.get(`/student/info/simplelist/`),
      getGraduate: (depId, degree, group) =>
        instance.get(
          `/student/info/graduate/?department=${depId}&degree=${degree}&group=${group}&school=${school_id}`
        ),
      postGraduate: (data) => instance.post(`/student/graduation/group/`, data),
      postCommand: (data) => instance.post(`/student/command/`, data),
      putRegNumAndDiplom: (data, pk) =>
        instance.put(`/student/regisanddiplom/${pk}/`, data),

      getStudent: (department, degree, profession, group, join_year) =>
        instance.get(
          `/student/info/list/?department=${department}&degree=${degree}&profession=${profession}&group=${group}&join_year=${join_year}&school=${school_id}`
        ),
      ...
      getStudentCommandList: () =>
        instance.get(
          `/student/graduate/list/?year=${cyear_name}&season=${cseason_id}&school=${school_id}`
        ),
      post: (data) => instance.post("/student/info/", data),
      getOne: (pk, type) =>
        instance.get(`/student/info/detail/${pk}/?type=${type}`),
      put: (data, pk, type) =>
        instance.put(`/student/info/detail/${pk}/?type=${type}`, data),
      delete: (pk) => instance.delete(`/student/info/${pk}/`),
      getStudentOne: (pk) =>
        instance.get(
          `/student/info/all/${pk}/?year=${cyear_name}&season=${cseason_id}`
        ),

      scoreRegister: (id) => instance.get(`/student/score-register/?id=${id}`),
      calculateGpaDimploma: (id) =>
        instance.get(`/student/calculate-gpa-diploma/?id=${id}`),
      calculateGpaDimplomaAdd: (id, data) =>
        instance.post(`/student/calculate-gpa-diploma/?id=${id}`, data),
      calculateGpaDimplomaGet: (studentId) =>
        instance.get(`/student/gpa-diploma-values/?id=${studentId}`),

      getLessonStudent: (student) =>
        instance.get(`/student/score-lesson/${student}/`),
      // оюутны жагсаалт import хийх
      postImportStudent: (data) => instance.post(`/student/import/`, data),
      // дата оруулах
      postStudentImportData: (data) =>
        instance.post(`/student/postData/`, data),

      // Голч бодуулах загвараар ангийн хүүхдүүдийн загварыг хадгалах
      calculateGpaGroupGraduation: (data) =>
        instance.post(`/student/calculate-gpa-diploma/group/`, data),

      postConfig: (data) =>
        instance.post(`/student/calculate-gpa-diploma/config/`, data),
      getConfig: (group, type) =>
        instance.get(
          `/student/calculate-gpa-diploma/config/?group=${group}&type=${type}`
        ),
      ...
      group: {
        getList: (departId, degree, profession, joined_year) => {
          ...
          return instance.get(
            `/student/group/list/?department=${depart_id}&degree=${degree_id}&profession=${profession_id}&join_year=${join_year}&schoolId=${school_id}`
          );
        },
        ...
        get: (
          ...
          instance.get(
            `/student/group/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&salbar=${department}&degree=${degree}&profession=${profession}&join=${join_year}&school=${school_id}&study=${only_study}`
          ),
        ...
        getTimetableList: (lesson) =>
          instance.get(
            `/student/group/timetable/${lesson}/?school=${school_id}`
          ),

        /** Багшаас хамаарах ангийн жагсаалт */
        getGroup: (teacher) =>
          instance.get(`/student/group/class/?teacher=${teacher}`),
        ...
        getAllList: (profession) => {
          ...
          if (profession) profession_id = profession;
          return instance.get(
            `/student/group/list/?profession=${profession_id}`
          );
        },
      ...
      family: {
        ...
        put: (data, pk, student) =>
          instance.put(`/student/family/${student}/${pk}/`, data),
        delete: (student, pk) =>
          instance.delete(`/student/family/${student}/${pk}/`),
      },
      /** Оюутны боловсрол */
      education: {
        ...
        put: (data, pk, student) =>
          instance.put(`/student/education/${student}/${pk}/`, data),
        delete: (student, pk) =>
          instance.delete(`/student/education/${student}/${pk}/`),
      },
      /** Оюутны хаяг */
      address: {
        get: (student) => instance.get(`/student/address/${student}/`),
        post: (data, student) =>
          instance.post(`/student/address/${student}/`, data),
      },
      /** Оюутны ЭЕШ-ийн оноо */
      admissionScore: {
        ...
        put: (data, pk, student) =>
          instance.put(`/student/admission/${student}/${pk}/`, data),
        delete: (student, pk) =>
          instance.delete(`/student/admission/${student}/${pk}/`),
      },
      /** Оюутны шилжилт хөдөлгөөн явсан*/
      movement: {
        get: (limit, page, sort, search, checked) =>
          instance.get(
            `/student/movement/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}&checked=${checked}`
          ),
      ...
      arrived: {
        get: (limit, page, sort, search, start, end, statement) =>
          instance.get(
            `/student/arrive/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}&start=${start}&end=${end}&statement=${statement}`
          ),
        ...
        postArrive: (data, pk) =>
          instance.post(`/student/arrive/approve/${pk}/`, data),
      },

      /** Оюутны чөлөөний бүртгэл */
      leave: {
        get: (limit, page, sort, search, year, state) =>
          instance.get(
            `/student/leave/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}&year=${year}&state=${state}`
          ),
      ...
      graduate: {
        get: (limit, page, sort, search, department, degree, group) =>
          instance.get(
            `/student/graduation/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}&department=${department}&degree=${degree}&group=${group}`
          ),
      ...
      eduloanfund: {
        get: (limit, page, sort, search, degree, group) =>
          instance.get(
            `/student/edu_loan_fund/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&degree=${degree}&group=${group}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}`
          ),
      },
      ...
      viz: {
        get: (limit, page, school, departId, profId, groupId, status) => {
          ...
          return instance.get(
            `/student/viz-status/?page=${page}&limit=${limit}&school=${schools}&department=${depart}&profession=${profIds}&group=${groups}&status=${viz_status}`
          );
        },
    ...
    timetable: {
      ...
      room: {
        getList: (room_type = "") =>
          instance.get(`/timetable/room/list/?room_type=${room_type}`),
      ...
      register: {
        get: (
          ...
          instance.get(
            `/timetable/register/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&day=${day}&group=${group}&lesson=${lesson}&teacher=${teacher}&time=${time}&school=${school_id}&checked=${checked}&type=${type}&isOptional=${isOptional}&lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        getCalendar: (
          isCalendar,
          selectedValue,
          ...
          instance.get(
            `/timetable/register-new/?school=${school_id}&year=${cyear_name}&season=${cseason_id}&isCalendar=${isCalendar}&selectedValue=${selectedValue}&type=${stype}&option=${optionFilter}&is_volume=${isVolume}`
          ),
        getCalendarKurats: (
          isCalendar,
          selectedValue,
          ...
          instance.get(
            `/timetable/register1/kurats/?school=${school_id}&year=${cyear_name}&season=${cseason_id}&isCalendar=${isCalendar}&selectedValue=${selectedValue}&type=${stype}&start=${start}&end=${end}&option=${optionFilter}`
          ),
        ...
        post: (data, type) =>
          instance.post(`/timetable/register/?type=${type}`, data),
        getOne: (pk) => instance.get(`/timetable/register/${pk}/`),
        getPotok: (lesson, potok) =>
          instance.get(
            `/timetable/list/?lesson=${lesson}&potok=${potok}&school=${school_id}&year=${cyear_name}&season=${cseason_id}`
          ),
        put: (data, pk) => instance.put(`/timetable/register/${pk}/`, data),
        delete: (pk) => instance.delete(`/timetable/register/${pk}/`),
        selectionDatas: (selectType, selectedValue, optionFilter, isVolume) =>
          instance.get(
            `/timetable/resource1/?school=${school_id}&year=${cyear_name}&season=${cseason_id}&stype=${selectType}&selectedValue=${selectedValue}&option=${optionFilter}&is_volume=${isVolume}`
          ),
        setEvent: (data, id) => instance.put(`/timetable/event/${id}/`, data),
        moveEvent: (data, id) =>
          instance.put(`/timetable/register/new/${id}/`, data),
        saveFile: (data) => instance.post(`/timetable/file/`, data),
      },
      // Шалгалтын хуваарь
      exam: {
        get: (limit, page, sort, search, group, teacher) =>
          instance.get(
            `/timetable/examtimetable/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}&group_id=${group}&teacher=${teacher}`
          ),
        post: (data) => instance.post("/timetable/examtimetable/", data),
        getOne: (pk) =>
          instance.get(`/timetable/examtimetable/${pk}/?school=${school_id}`),
        put: (data, pk) =>
          instance.put(`/timetable/examtimetable/${pk}/`, data),
        ...
        getExamStudent: (lesson, room_capacity, examId = "") =>
          instance.get(
            `/student/info/lesson/${lesson}/?group_limit=${room_capacity}&schoolId=${school_id}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&exam=${examId}`
          ),
      },
      ...
      re_exam: {
        get: (limit, page, sort, search, status) =>
          instance.get(
            `/timetable/exam_repeat/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&status=${status}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}`
          ),
        ...
        getStudentLessonScore: (student, lesson) =>
          instance.get(
            `/timetable/exam_repeat/score/${student}/${lesson}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
      },
    },
    // /** Сургалтын төлбөр */
    ...
    score: {
      print: {
        get: (studentId, year, season) =>
          instance.get(
            `/score/print/${studentId}/?year=${year}&season=${season}`
          ),
      },
      correspond: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/score/correspond/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}`
          ),
      ...
      register: {
        get: (limit, page, sort, search, group, lesson, teacher) =>
          instance.get(
            `/score/register/list/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson=${lesson}&teacher=${teacher}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&group=${group}&school=${school_id}`
          ),
      ...
      rescore: {
        get: (search, status, lesson_id, sort) =>
          instance.get(
            `/score/rescore/?search=${search}&status=${status}&lesson=${lesson_id}&sorting=${sort}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}`
          ),
    ...
    print: {
      ...
      gpa: {
        ...
        post: (profession, status, level) =>
          instance.post(
            `/print/gpa-profession/?profession=${profession}&status=${status}&level=${level}`
          ),
      },
      /* Дүнгийн жагсаалт*/
      score: {
        getList: (
          ...
          instance.get(
            `/print/group/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&department=${department}&group=${group}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}&is_season=${radio}&chosen_year=${chosenYear}&chosen_season=${chosenSeason}&lesson=${chosenLesson}`
          ),
        getListNoLimit: (group, radio, chosenYear, chosenSeason) =>
          instance.get(
            `/print/groupnolimit/?group=${group}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&is_season=${radio}&chosen_year=${chosenYear}&chosen_season=${chosenSeason}`
          ),
        ...
        getLessonList: (
          ...
          instance.get(
            `/print/lesson/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson=${lesson}&select_year=${lesson_year}&select_season=${lesson_season}&group=${group}&school=${school_id}`
          ),
        getStudentList: (
          limit,
          page,
          ...
          instance.get(
            `/print/student/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&student=${student}&select_year=${lesson_year}&select_season=${lesson_season}&school=${school_id}`
          ),
      },
      /** Төгсөлтийн ажил*/
      graduationwork: {
        get: (
          ...
          instance.get(
            `/print/graduationwork/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&degree=${degree}&group=${group}&department=${department}&profession=${profession}&learning=${learning}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}`
          ),
      },
      /** Элсэлтийн тушаал*/
      admission: {
        get: (limit, page, sort, search, admission, profession) =>
          instance.get(
            `/print/admission/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&admission=${admission}&profession=${profession}`
          ),
      ...
      admissionprint: {
        get: (degree, department, group, profession, learning) =>
          instance.get(
            `/print/admission/print/?degree=${degree}&group=${group}&department=${department}&profession=${profession}&learning=${learning}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}`
          ),
      },
    },
    /* Тэтгэлэг бүртгэх */
    stipend: {
      register: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/stipend/register/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
      ...
      request: {
        get: (limit, page, sort, search, solved, stipend) => {
          ...
          return instance.get(
            `/stipend/request/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&schoolId=${school_id}&solved=${solved}&stipend=${stipent}`
          );
        },
      ...
      information: {
        get: () => instance.get(`/stipend/information/`),
      },
    },
    /** Сургалтын хуанли */
    calendar: {
      get: (searchType) => {
        ...
        return instance.get(
          `/calendar/info/?schoolId=${school_id}${check_ids}`
        );
      },
    ...
    dormitory: {
      ...
      request: {
        get: (
          ...
          instance.get(
            `/dormitory/request/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school_id=${school_id}&class_id=${class_id}&lesson_year=${cyear_name}&roomtype=${roomtype_id}&room=${room}&solved=${solvedId}`
          ),
        ...
        another: {
          get: (limit, page, sort, search) =>
            instance.get(
              `/dormitory/request/another/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}`
            ),
          getOne: (pk) => instance.get(`/dormitory/request/another/${pk}/`),
          post: (data) => instance.post(`/dormitory/request/another/`, data),
          put: (data, pk) =>
            instance.put(`/dormitory/request/another/${pk}/`, data),
        },
        rent: {
          get: (limit, page, sort, search, is_teacher) =>
            instance.get(
              `/dormitory/request/rent/?is_teacher=${is_teacher}&page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}`
            ),
          getOne: (pk) => instance.get(`/dormitory/request/rent/${pk}/`),
          post: (data) => instance.post(`/dormitory/request/rent/`, data),
          put: (data, pk) =>
            instance.put(`/dormitory/request/rent/${pk}/`, data),
        },
      },
      ...
      type: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/dormitory/type/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
      ...
      /** Өрөө */
      room: {
        get: (limit, page, sort, search, roomtype, gender) =>
          instance.get(
            `/dormitory/room/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&room_type=${roomtype}&gender=${gender}`
          ),
        getList: (room_type = "") =>
          instance.get(`/dormitory/room/list/?room_type=${room_type}`),
      ...
      /** Төлбөрийн тохиргоо */
      payment: {
        get: (limit, page, sort, search, room_type, lesson_year) =>
          instance.get(
            `/dormitory/payment/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&room_type=${room_type}&lesson_year=${lesson_year}`
          ),
      ...
      estimate: {
        our: {
          get: (limit, page, sort, search, school_id, roomtype_id, room) =>
            instance.get(
              `/dormitory/estimate/our/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&school=${school_id}&roomtype=${roomtype_id}&room=${room}`
            ),
          put: (data, pk) =>
            instance.put(`/dormitory/estimate/our/${pk}/`, data),
        },
        another: {
          get: (limit, page, sort, search, roomtype_id, room) =>
            instance.get(
              `/dormitory/estimate/another/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&roomtype=${roomtype_id}&room=${room}`
            ),
          getOne: (pk) => instance.get(`/dormitory/estimate/another/${pk}/`),
          put: (data, pk) =>
            instance.put(`/dormitory/estimate/another/${pk}/`, data),
        },
        family: {
          get: (
            limit,
            ...
            instance.get(
              `/dormitory/estimate/family/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&year=${year}&month=${month}&payment_type=${payment_type}&is_teacher=${is_teacher}`
            ),
          post: (data = "") =>
            instance.post(`/dormitory/estimate/family/`, data),
          put: (data, pk) =>
            instance.put(`/dormitory/estimate/family/${pk}/`, data),
        },
      },
      /** Бараа материал */
      inv: {
      ...
      inv_request: {
        get: (limit, page, sort, search, stateId) =>
          instance.get(
            `/dormitory/inventory/request/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&state=${stateId}`
          ),
        post: (data) =>
          instance.post(`/dormitory/inventory/request/`, data, multiPart),
        getOne: (pk) => instance.get(`/dormitory/inventory/request/${pk}/`),
        put: (data, pk) =>
          instance.put(`/dormitory/inventory/request/${pk}/`, data, multiPart),
        delete: (pk) => instance.delete(`/dormitory/inventory/request/${pk}/`),
      },

      /** Төлбөрийн гүйлгээ */
      transaction: {
        get: (limit, page, sort, search, paymentType) =>
          instance.get(
            `/dormitory/transaction/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&paymentType=${paymentType}`
          ),
    ...
    request: {
      ...
      unit: {
        get: (limit, page, sort, search, unit) =>
          instance.get(
            `/request/unit/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&unit=${unit}`
          ),
      ...
      /** Өргөдөлийн төрөл */
      complaint: {
        get: (limit, page, sort, search, solved, complaintTypeId, menu) =>
          instance.get(
            `/request/complaint/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&solved=${solved}&complaint_type_id=${complaintTypeId}&lesson_year=${cyear_name}&menu=${menu}`
          ),
        post: (data, menu_id) =>
          instance.post(`/request/answercomplaint/?menu=${menu_id}`, data),
        getOne: (pk, menu_id) =>
          instance.get(`/request/complaint/${pk}/?menu=${menu_id}`),
      },
      /** Чөлөөний хүсэлт */
      leave: {
        get: (limit, page, sort, search, menu_id, leave_type_id) =>
          instance.get(
            `/request/leave/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&menu=${menu_id}&leave_type_id=${leave_type_id}`
          ),
        post: (data, menu_id) =>
          instance.post(`/request/leaveanswer/?menu=${menu_id}`, data),
        getOne: (pk, menu_id) =>
          instance.get(`/request/leave/${pk}/?menu=${menu_id}`),
      },
      /** Дүнгийн дүйцүүлэлт хийх хүсэлт */
      correspond: {
        get: (limit, page, sort, search, menu, solved) =>
          instance.get(
            `/request/correspond/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&menu=${menu}&solved=${solved}`
          ),
        getLessonData: (pk) =>
          instance.get(`/request/correspond/lesson/${pk}/`),
        ...
        postAnswer: (data, menu) =>
          instance.post(`/request/correspond/answer/?menu=${menu}`, data),
        getAnswer: (pk) => instance.get(`/request/correspond/answer/${pk}/`),
        // БМА батлах
        postApprove: (pk, data) =>
          instance.post(`/request/correspond/approve/${pk}/`, data),
      },
      /** Олон нийтийн ажилд оролцох хүсэлтийн шийдвэр */
      volunteer: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/request/volunteer/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        getOne: (pk) =>
          instance.get(
            `/request/volunteer/${pk}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        put: (data, pk) =>
          instance.put(
            `/request/volunteer/${pk}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`,
      ...
      /** Клуб */
      club: {
        get: (limit, page, sort, search, type_id = "") =>
          instance.get(
            `/request/club/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&type_id=${type_id}`
          ),
        ...
        getRegisterStudent: (limit, page, sort, search, club) =>
          instance.get(
            `/request/club/student/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&club=${club}`
          ),
        getOneRegisterStudent: (pk) =>
          instance.get(`/request/club/student/${pk}/`),
        putRegisterStudent: (pk, data) =>
          instance.put(`/request/club/student/${pk}/`, data),
      },

      /** Тойрох хуудас */
      routing: {
        get: (limit, page, sort, search, menu_id, type_id) =>
          instance.get(
            `/request/routing/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&menu=${menu_id}&type=${type_id}`
          ),
        post: (data, menu_id) =>
          instance.post(`/request/routing/answer/?menu=${menu_id}`, data),
        getOne: (pk, menu_id) =>
          instance.get(`/request/routing/${pk}/?menu=${menu_id}`),
      },
      /** Багшийн туслахаар ажиллах хүсэлт */
      tutor: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/request/tutor/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        getOne: (pk) =>
          instance.get(
            `/request/tutor/${pk}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        put: (data, pk) =>
          instance.put(
            `/request/tutor/${pk}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`,
    ...
    order: {
      ...
      hospital: {
        get: (
          ...
          instance.get(
            `/order/hospital/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&is_today=${is_today}&flag=${flag}`
          ),
      },
      /** Бялдаржуулах төв */
      gym: {
        ...
        get: (limit = "", page = "", sort = "", search = "") =>
          instance.get(
            `/order/gym/payment/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
        ...
        // Бүртгүүлсэн оюутнуудын жагсаалт
        getRegisterStudent: (limit, page, sort, search, gym_payment_id) =>
          instance.get(
            `/order/gym/student/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&gym_payment_id=${gym_payment_id}`
          ),
        getOneRegisterStudent: (pk) =>
          instance.get(`/order/gym/student/${pk}/`),
      },
      /** Номын сан */
      library: {
        get: (
          ...
          instance.get(
            `/order/library/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&room=${room}&is_today=${is_today}&flag=${flag_id}`
          ),
    ...
    service: {
      news: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/service/news/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
        ...
        //Зар
        getAd: (limit, page, sort, search) =>
          instance.get(
            `/service/news/ad/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
    ...
    credit: {
      // Цагийн ачаалал
      volume: {
        get: (limit, page, sort, search, dep_id, year, teacherId, season) =>
          instance.get(
            `/credit/volume/?page=${page}&limit=${limit}&sorting=${sort}&school=${school_id}&department=${dep_id}&lesson_year=${year}&teacher=${teacherId}&search=${search}&lesson_season=${season}`
          ),
        post: (data) =>
          instance.post(`/credit/volume/?lesson_year=${cyear_name}`, data),
        estimate: (dep_id, year, season, teacher) =>
          instance.post(
            `/credit/volume/estimate/?dep_id=${dep_id}&schoolId=${school_id}&lesson_year=${year}&season=${season}&teacher=${teacher}`
          ),
        ...
        printGet: (dep_id, year, teacherId) =>
          instance.get(
            `/credit/volume/print/?school=${school_id}&department=${dep_id}&lesson_year=${year}&teacher=${teacherId}`
          ),
      },
      settings: {
        get: (limit, page, search, type) =>
          instance.get(
            `/credit/settings/?page=${page}&limit=${limit}&search=${search}&type=${type}`
          ),
        getAll: (type) => instance.get(`/credit/settings/all/?type=${type}`),
        post: (data) => instance.post(`/credit/settings/`, data),

        put: (data, pk) => instance.put(`/credit/settings/${pk}/`, data),
      ...
      performance: {
        get: (limit, page, search) =>
          instance.get(
            `/credit/settings/performance/?page=${page}&limit=${limit}&search=${search}`
          ),

        post: (data) => instance.post(`/credit/settings/performance/`, data),
      ...
      parttime: {
        get: (limit, page, month) => {
          ...
          return instance.get(
            `/credit/part-time/?page=${page}&limit=${limit}${mount_ids}&school=${school_id}`
          );
        },
      },
      ...
      // A цагийн тооцоо
      estimation: {
        get: (limit, page, search, season, dep_id, teacherId) =>
          instance.get(
            `credit/a_estimation/?page=${page}&limit=${limit}&search=${search}&lesson_year=${cyear_name}&lesson_season=${season}&department=${dep_id}&teacher=${teacherId}&school=${school_id}`
          ),
        post: (data) =>
          instance.post(`credit/a_estimation/?lesson_year=${cyear_name}`, data),

        // А цагийн тооцоо бодох
        estimate: (department, season, teacher) =>
          instance.post(
            `credit/a_estimation/estimate/?season=${season}&department=${department}&teacher=${teacher}`
          ),

        // Танхимийн бус цагийн төрөл авах
        getChamberType: (editId) =>
          instance.get(`credit/a_estimation/chamber/?timeestimate=${editId}`),

        postChamber: (data) =>
          instance.post(`credit/a_estimation/chamber/`, data),
      },
    },
    ...
    role: {
      ...
      teacherscore: {
        get: (limit, page, sort, search, teacher_id) =>
          instance.get(
            `permissions/teachers/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&teacher=${teacher_id}`
          ),
        getOne: (pk) =>
          instance.get(
            `permissions/teachers/${pk}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        /**зөвхөн багшийн мэдээлэл */
        getTeacher: () =>
          instance.get(
            `permissions/teacher_info/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        /**зөвхөн багшийн заах хичээлүүдийг авах */
        getLesson: (teacher) =>
          instance.get(
            `permissions/lesson_info/?lesson_year=${cyear_name}&lesson_season=${cseason_id}&teacher=${teacher}`
          ),
        /**зөвхөн багшийн заах хичээлүүдийн дүгнэх хэлбэр авах */
        getType: (teacher_id, lesson_id) =>
          instance.get(
            `permissions/type/?teacher=${teacher_id}&lesson=${lesson_id}`
          ),
        post: (data) =>
          instance.post(
            `permissions/teachers/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`,
            data
          ),
        put: (data, pk) =>
          instance.put(
      ...
      other: {
        get: (limit, page, sort, search, other_id) =>
          instance.get(
            `permissions/other/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&other=${other_id}`
          ),
        getOne: (pk) =>
          instance.get(
            `permissions/other/${pk}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        post: (data) =>
          instance.post(
            `permissions/other/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`,
            data
          ),
        put: (data, pk) =>
          instance.put(
      ...
      student: {
        get: (limit, page, sort, search, student) =>
          instance.get(
            `permissions/student/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${cyear_name}&lesson_season=${cseason_id}&student=${student}`
          ),
        getOne: (pk) =>
          instance.get(
            `permissions/student/${pk}/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`
          ),
        getStudent: (search) =>
          instance.get(
            `permissions/students/?lesson_year=${cyear_name}&lesson_season=${cseason_id}&search=${search}`
          ),
        getSelectStudents: (state) =>
          instance.get(
            `permissions/students/select_bottom/?lesson_year=${cyear_name}&lesson_season=${cseason_id}&state=${state}`
          ),
        post: (data) =>
          instance.post(
            `permissions/student/?lesson_year=${cyear_name}&lesson_season=${cseason_id}`,
            data
          ),
        put: (data, pk) =>
          instance.put(
      ...
      check: {
        get: (type) =>
          instance.get(`permissions/check/?permission_type=${type}`),
      },

      crontab: {
        get: (page, limit, search) =>
          instance.get(
            `permissions/crontab/?page=${page}&limit=${limit}&search=${search}`
          ),
    ...
    challenge: {
      get: (page, limit, lesson, type) =>
        instance.get(
          `learning/challenge/?page=${page}&limit=${limit}&lesson=${lesson}&type=${type}`
        ),
      ...
      getSelect: (type, lesson) =>
        instance.get(
          `learning/challenge/select/?type=${type}&year=${cyear_name}&season=${cseason_id}&lesson=${lesson}`
        ),

      post: (data) =>
        instance.post(
          `learning/challenge/?year=${cyear_name}&season=${cseason_id}`,
          data
        ),

      put: (data, id) =>
        instance.put(
          `learning/challenge/${id}/?year=${cyear_name}&season=${cseason_id}`,
          data
        ),

      delete: (id) => instance.delete(`learning/challenge/${id}/`),

      send: (id) => instance.get(`learning/challenge/send/${id}/`),

      // ХБА шалгалт батлуулах хүсэлт
      getApprove: (page, limit, sort, search, type, teacherId, lessonId) =>
        instance.get(
          `learning/challenge/approve/?page=${page}&limit=${limit}&type=${type}&sorting=${sort}&search=${search}&teacher=${teacherId}&lesson=${lessonId}`
        ),

      postAnswer: (data) => instance.post(`learning/challenge/approve/`, data),
      question: {
        get: (page, limit, lessonId, subjectId, search) =>
          instance.get(
            `learning/questions/?page=${page}&limit=${limit}&lesson=${lessonId}&subject=${subjectId}&search=${search}`
          ),
        ...
        getList: (checked_ids, count, type) => {
          ...
          return instance.get(
            `learning/questions/list/?count=${count}&type=${type}${check_ids}`
          );
        },

        post: (data) =>
          instance.post(
            `learning/questions/?year=${cyear_name}&season=${cseason_id}`,
            data
          ),

        put: (data, pk) =>
          instance.put(
            `learning/questions/${pk}/?year=${cyear_name}&season=${cseason_id}`,
            data
          ),
        ...
        delete: (delete_ids) => {
          ...
          return instance.delete(
            `learning/questions/?year=${cyear_name}&season=${cseason_id}${remove_ids}`
          );
        },
      },
    },
    ...
    survey: {
      ...
      surveyrange: {
        ...
        get: (types, selectedValue) =>
          instance.get(
            `survey/surveyrange/?types=${types}&selected_value=${selectedValue}`
          ),
      },
      get: (limit, page, selectedTime, search) =>
        instance.get(
          `survey/?limit=${limit}&page=${page}&time_type=${selectedTime}&search=${search}`
        ),
    ...
    evaluation: {
      register: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/survey/questions/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
    ...
    science: {
      paper: {
        get: (
          ...
          instance.get(
            `/science/papers/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&sub_org=${school_id}&salbar=${salbar}&teachers=${teacher}&published_year=${publish_year}&category=${category}`
          ),
        category: {
      ...
      notes: {
        get: (limit, page, sort, search, category, salbar) =>
          instance.get(
            `/science/notes/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&category=${category}&salbar=${salbar}`
          ),
        values: {
      ...
      quotation: {
        get: (limit, page, sort, search, salbar, category, quotation_year) =>
          instance.get(
            `/science/quotation/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&salbar=${salbar}&category=${category}&quotation_year=${quotation_year}`
          ),
      },
      ...
      invention: {
        get: (
          ...
          instance.get(
            `/science/invention/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&sub_org=${school_id}&salbar=${salbar}&teachers=${teacher}&published_year=${publish_year}&category=${category}`
          ),
        category: {
      ...
      project: {
        get: (
          ...
          instance.get(
            `/science/project/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&salbar=${salbar}&teacher=${teacher}&start_date=${start_date}&category=${category}&sub_category=${sub_category}`
          ),
        category: {
      ...
      settings: {
        ...
        post: (type, datas) =>
          instance.post(`/science/settings/?type=${type}`, datas),
        put: (type, datas) =>
          instance.put(`/science/settings/?type=${type}`, datas),
        delete: (type, id) =>
          instance.delete(`/science/settings/${id}/?type=${type}`),
      },

      student: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/science/student/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
      },
      ...
      patent: {
        get: (limit, page, sort, search) =>
          instance.get(
            `/science/patent/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}`
          ),
      },
      estimate: {
        get: (limit, page, sort, search, salbar) =>
          instance.get(
            `/science/estimate/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&school=${school_id}&salbar=${salbar}`
          ),
      },
    ...
    elselt: {
      get: (limit, page, sort, search, lesson_year) =>
        instance.get(
          `/elselt/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year=${lesson_year}`
        ),
      ...
      profession: {
        get: (elselt_id) =>
          instance.get(`/elselt/profession/?elselt=${elselt_id}`),
        post: (data) => instance.post("/elselt/profession/", data),
        delete: (id, elselt_id) =>
          instance.delete(`/elselt/profession/${id}/?elselt=${elselt_id}`),
        postShalguur: (datas) =>
          instance.post(`/elselt/profession/shalguur/`, datas),
      ...
      admissionuserdata: {
        get: (
          ...
          instance.get(
            `/elselt/admissionuserdata/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year_id=${lesson_year_id}&profession_id=${profession_id}&unit1_id=${unit1_id}&gender=${gender}&state=${state}&gpa_state=${gpa_state}`
          ),
        getOne: (pk) => instance.get(`/elselt/admissionuserdata/${pk}/`),
        put: (data, id) =>
          instance.put(`/elselt/admissionuserdata/${id}/`, data),
        ...
        email: {
          get: (
            ...
            instance.get(
              `/elselt/admissionuserdata/email/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&lesson_year_id=${lesson_year_id}&profession_id=${profession_id}&unit1_id=${unit1_id}&gender=${gender}&state=${state}&gpa_state=${gpa_state}`
            ),
          post: (data) =>
            instance.post(`/elselt/admissionuserdata/email/`, data),
        },
      },
      gpa: {
      ...
      health: {
        anhan: {
          get: (limit, page, sort, search, state) =>
            instance.get(
              `/elselt/health/anhan/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&state=${state}`
            ),
          post: (cdata) => instance.post(`/elselt/health/anhan/`, cdata),
          put: (id, cdata) =>
            instance.put(`/elselt/health/anhan/${id}/`, cdata),
        },
        professional: {
          get: (limit, page, sort, search, state) =>
            instance.get(
              `/elselt/health/professional/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&state=${state}`
            ),
          post: (cdata) => instance.post(`/elselt/health/professional/`, cdata),
          put: (id, cdata) =>
            instance.put(`/elselt/health/professional/${id}/`, cdata),
        },
        physical: {
          get: (limit, page, sort, search, state) =>
            instance.get(
              `/elselt/health/physical/?page=${page}&limit=${limit}&sorting=${sort}&search=${search}&state=${state}`
            ),
