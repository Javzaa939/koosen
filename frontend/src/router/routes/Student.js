...
const SumEn = lazy(() => import("@views/Student/Definition/Sum/SumEn"))
...
const PrintAll = lazy(() => import("@views/Student/Attachment/PrintAll"))
...
const Print = lazy(() => import("@views/Student/Leave/Print"))
...
const StudentRoutes = [
    ...
    {
        path: 'student/attachment/print-all/',
        element: <PrintAll />,
        meta: {
            layout: 'blank'
        }
