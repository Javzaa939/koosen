        ...
        if (Object.keys(user).length > 0) {
            ...
            navigation.forEach((menus) => {
                if (
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-reference-departments-read',
                        'reference2',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-dashboard-read',
                        'elselt0',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-main-read',
                        'elselt1',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-yesh-read',
                        'elselt3_4',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-health-read',
                        'elselt4',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-healthup-read',
                        'elselt5',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-physical-read',
                        'elselt6',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-psychological-read',
                        'elselt3_1',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-justice-read',
                        'elselt3_3',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-army-read',
                        'elselt6_1',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-mail-read',
                        'elselt8',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-elselt-message-read',
                        'elselt9',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-psychologicaltesting-question-read',
                        'psychologicaltesting0',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-psychologicaltesting-exam-read',
                        'psychologicaltesting1',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-psychologicaltesting-result-read',
                        'psychologicaltesting2',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-settings-student-read',
                        'settings_student',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-settings-mail-read',
                        'settings_mail',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-score-report-read',
                        'score6',
                    );
                    childrenDatas = checkPerm(childrenDatas, menus, 'lms-score-read', 'score7');
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-dormitory-paymentconfig-read',
                        'dormitory3',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-survey-list-read',
                        'takesurvey',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-survey-result-read',
                        'surveyreg',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-browser-structure-read',
                        'b1',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-browser-surgalt-read',
                        'b2',
                    );
                    ...
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-browser-library-read',
                        'b6',
                    );
                    childrenDatas = checkPerm(
                        childrenDatas,
                        menus,
                        'lms-browser-health-read',
                        'b7',
                    );
            ...
            newMenu.map((menus, idx) => {
                ...
                if (menus.navChildren && menus && menus.children && menus.children.length < 1) {
                    ...
                    /** Хуанли */
                    if (menus.id === 'calendar' && !user.permissions?.includes('lms-calendar-read'))
                        delete newMenu[idx];

                    /** Зар мэдээ */
                    if (
                        menus.id === 'service' &&
                        !user.permissions?.includes('lms-service-news-read')
                    )
                        delete newMenu[idx];
                    ...
                    if (
                        menus.id === 'statistic' &&
                        !user.permissions?.includes('lms-statistic-read')
                    )
                        delete newMenu[idx];

                    /** Хандах эрх */
                    if (menus.id === 'role' && !user.permissions?.includes('lms-role-read'))
                        delete newMenu[idx];

                    /** ----------------------------- Цахим сургалт ---------------------------- */
                    if (menus.id === 'remotelesson' && !user.permissions?.includes('lms-role-read'))
                        delete newMenu[idx];
                }
            });
