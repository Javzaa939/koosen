...
export default function Leave()
{
    ...
    {
        const { success, data } = await allFetch(studentComplaintLeaveApi.get(rowsPerPage, currentPage, sortField, searchValue, menu_id, LeaveTypeId))
        if (success)
        {
    ...
    useEffect(
        ...
        [rowsPerPage, currentPage, sortField, LeaveTypeId]
    )
        ...
        <Fragment>
            <Card>
                <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
					<CardTitle tag="h4">{t('Чөлөөний хүсэлт хайх')}</CardTitle>
				</CardHeader>
                <Row className="mx-0 mt-1">
					<Col md={4} className='mb-1'>
						<Label className= "form-label me-1" for="is_solved">
							{t('Шийдвэрийн төрөл')}
						</Label>
                        <Select
                            name="is_solved"
                            ...
                            options={leaveTypes || []}
                            value={leaveTypes.find((c) => c.id === LeaveTypeId)}
            ...
            <Card>
                <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom">
					<CardTitle tag="h4">{t('Чөлөөний хүсэлтийн жагсаалт')}</CardTitle>
				</CardHeader>
                ...
                <div className='react-dataTable react-dataTable-selectable-rows' id='datatableLeftTwoRightOne' >
                    <DataTable
                        ...
                        columns={getColumns(currentPage, rowsPerPage, total_count, roleMenus, handleRequestSolve, handleRequestDetail)}
