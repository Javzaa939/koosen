...
const FieldPreparation = () => {
    ...
    async function getDatas() {
        const {success, data} = await fetchData(elseltApi.get(rowsPerPage, currentPage, sortField, searchValue, state, adm, profession_id))
        if(success) {
    ...
    }, [sortField, currentPage, rowsPerPage, searchValue, state,adm, profession_id])
        ...
        <Fragment>
            ...
            <Card>
                <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom ">
                    <CardTitle tag="h4">{t('Цэргийн хээрийн бэлтгэлд тэнцсэн эсэхийн бүртгэл')}</CardTitle>
                </CardHeader>
