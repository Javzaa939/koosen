...
import { Col, Button, Input, Card, CardHeader, CardTitle, Row, Spinner, Label, CardBody, Table } from 'reactstrap'
...
const AllReport = () => {
    ...
    async function getGroup() {
        const { success, data } = await fetchData(groupApi.getList('', '', select_value.profession))
        if (success) {
            setGroup(data)
        }
    }
