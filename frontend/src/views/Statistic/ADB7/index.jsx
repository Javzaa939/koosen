...
function ADB7(){
    ...
    function convert() {
            ...
            utils.book_append_sheet(workbook, worksheet, "A-DB-7-Report")
            const staticCells = [
                'Ерөнхий чиглэл',
                'Төрөлжсөн чиглэл',
                ' ',
            ...
            for (let row = startRow; row <= endRow; row++) {
                ...
                worksheet[cellAddress].v = (row === 1 && col === 0) ?
                    ...
                    : (row === 3 && col === 0 ) ? cyear_name ? 'ДЭЭД БОЛОВСРОЛЫН СУРГАЛТЫН  БАЙГУУЛЛАГАД СУРАЛЦАГЧДЫН' + ' '+  cyear_name.replace('-', '/') + ' ' + 'ОНЫ ХИЧЭЭЛИЙН ЖИЛИЙН МЭДЭЭ, мэргэжлийн чиглэлээр'
                            : 'ДЭЭД БОЛОВСРОЛЫН СУРГАЛТЫН  БАЙГУУЛЛАГАД СУРАЛЦАГЧДЫН 20... / 20... ОНЫ ХИЧЭЭЛИЙН ЖИЛИЙН МЭДЭЭ, мэргэжлийн чиглэлээр'
                        : ''
                }
            }
            ...
            writeFile(workbook, "A-DB-7.xlsx", { compression: true });
