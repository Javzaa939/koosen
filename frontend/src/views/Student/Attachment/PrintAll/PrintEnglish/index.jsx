...
export default function PrintAttachmentEnglish()
{
    ...
    return (
        <div className='d-flex flex-column justify-content-between pb-50' style={{ height: '100vh', overflow: 'hidden' }}>
            {Loading && Loader}
            {/*
            ...
            <div className='' style={{ flex: 1 }}>
                ...
                >
                    ...
                    <div className='d-flex flex-column text-center fw-bolder'>
                        ...
                        <p className='text-uppercase' style={{ marginBottom: '0px' }} >{printDatas?.student?.school_name_eng ? printDatas?.student?.school_name_eng : printDatas?.student?.group?.department?.school_eng}</p>
                    ...
                    <div className='fw-bolder d-flex' style={{ fontSize: '11px' }} >
                        ...
                        <div className='d-flex px-2' style={{ width: printDatas?.student?.group?.degree?.degree_code === 'D' && printDatas?.student?.eysh_score ? '25%' : '33.3%' }} >
                            <span className='fw-normal w-50' style={{ width: '200px'}}>Graduated:</span> <span>{printDatas?.student?.graduation_work?.decision_date?.substring(0, 4)}</span>
                        </div>
                    </div>
                    <div className='fw-bolder d-flex' style={{ fontSize: '11px' }} >
                        <div className='d-flex' style={{ width: printDatas?.student?.group?.degree?.degree_code === 'D' && printDatas?.student?.eysh_score ? '25%' : '33.3%' }} >
