...
const Graduation = () => {
    ...
    const getGroup = async () => {
        const { success, data } = await allFetch(
            groupApi.getList(select_value.department, select_value.degree),
        );
        if (success) {
            setGroupOption(data);
        }
    ...
    return (
        <Fragment>
            ...
            <Card>
                ...
                <CardHeader className="flex-md-row flex-column align-md-items-center align-items-start border-bottom align-items-center py-1">
                    ...
                    <div className="d-flex flex-wrap mt-md-0 mt-1 gap-1">
                        <Button color="primary" onClick={() => handleModalSig()}>
                            <Plus size={15} />
                    ...
                    <div className="d-flex flex-wrap mt-md-0 mt-1 gap-1 align-items-center">
                        ...
                        <Button
                            ...
                            disabled={
                                ...
                                user.permissions.includes('lms-student-graduate-create') &&
                                school_id
                                    ? false
                                    : true
                            }
                ...
                <Row className="justify-content-between mx-0 mt-1 mb-1" sm={12}>
                    ...
                    <Col sm={6} md={6} lg={3} className="mt-2 d-flex">
                        ...
                        <Button
                            ...
                            onClick={handleCommandCreateModal}
                        >
                            Төгсөлтийн тушаал оруулах
                        </Button>
                    </Col>
                </Row>
            ...
            {commandModal && (
                <GraduationCommand
                    open={commandModal}
                    handleModal={handleCommandCreateModal}
                    refreshDatas={getDatas}
                    studentOption={datas}
                />
            )}
