...
import { Modal, Row, Col, ModalHeader, ModalBody, Input, Label, Button, Badge } from 'reactstrap'
                    ...
                    :
                        ...
                        <div className='p-1 fw-bolder'>
                            <Badge color={`light-warning`} pill className="d-inline-block pe-1 align-items-center">
                                <div className='text-wrap d-flex align-items-center' style={{ fontSize: 16}}>
                                    <AlertTriangle className='m-1' style={{ width: 24, height: 24 }}  />
