...
export default function AmountDetailsEn()
{
                ...
                <>
                    ...
                    <div style={{ borderBottom: '1px solid gray' }} />
                        ...
                        <div className="text-center mt-2 fw-bolder fs-3">
                            Дүнгийн дэлгэрэнгүй definition
                        </div>
                        ...
                        <table className={`fw-bolder mt-2 text-center border-0`} style={{ width: '98%', fontSize: '12px' }} >
                            <thead className="w-100">
                                ...
                                <tr>
                                    ...
                                    <td rowSpan={2} className="text-center border border-dark" style={{ width: '8%' }}>Чанар</td>
                                </tr>
                                <tr>
                            ...
                            <tbody className="w-100">
                                {seasons.map((season, sidx) => {
                                    ...
                                    return(
                                        <>
                                            <tr>
                                                <td className="border-dark" colSpan={9}>{season?.year_season}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border-dark">{totalChanarHandler(chanars)}</td>
                                            </tr>
                                        </>
                                    )}
                                )}
                                <tr>
                                    ...
                                    {/* Тодорхойлолтыг нэг улирлаар харах тохиолдолд доорхи хүснэгтийн colSpan буюу баганы хэмжээг
                                        5 болгож Нийт чанарын тоог харуулахгүй.
                                    */}
                                    <td className='text-center border-dark' colSpan={seasons.length == 1 ? 5 : 4} style={{ fontStyle: 'italic' }}>
                                        {`[${mdata.asses_count.map((ass,aidx) => (ass?.assessment__assesment + ": " + ass?.asses_count))}]`}
                                    </td>
                                    <td className={`text-center border-dark ${seasons.length ==  1 ? 'd-none' : ''}`} style={{ fontStyle: 'italic' }}>
                                        {niit_chanar()}
                                    </td>
                                </tr>
