...
import { Activity, Briefcase, Users, XCircle } from 'react-feather'
    ...
    return (
        <Row>
            <Col md={9} xs={12}>
                <Card>
                    <CardTitle tag="h5">
                        {currentYear ? t('Тухайн хичээлийн жилд гэрээ хийсэн оюутны тоо') : t('Суралцагчийн тоо төлөвөөр')}
                    </CardTitle>
                    <CardSubtitle
