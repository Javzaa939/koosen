...
const List5 = () => {
    ...
    async function getChartData() {
        const { success, data } = await graFetchData(challengeApi.chart2(select_value.department, select_value.lesson_year, select_value.season, select_value.teacher, select_value.lesson))
        if (success) {
            setDatas(data)
        }
    }
