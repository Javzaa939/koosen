...
const AnotherStudent = () => {
    ...
    async function getDatas() {
        const { success, data } = await fetchData(dormitoryEstimateAnotherApi.get(rowsPerPage, currentPage, sortField, searchValue, roomtype_id, room_id))
        if(success) {
    ...
    useEffect(() => {
        getDatas()
    },[rowsPerPage, currentPage, sortField, roomtype_id, room_id])
