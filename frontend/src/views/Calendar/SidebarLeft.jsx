    ...
    return (
        <Fragment>
            <div className='sidebar-wrapper'>
                {
                    Object.keys(user).length > 0 && user.permissions.includes('lms-calendar-create') &&
                    <>
                            ...
                            <Col>
                                <Row>
                                    <Card className='border-0 mb-0 p-1 sidebar-left-color1 py-2'>
                                        ...
                                        <p className='text-center d-flex align-items-end' style={{fontSize: '12px'}}>{t('Долоо хоног')}</p>
                                    </Card>
                                </Row>
                            </Col>
                            <Col>
                                <Row>
                                    <Col className='d-flex align-items-start'>
                                        <p className='text-center' style={{fontSize: '12px'}}>{t('Хичээлийн жил')}</p>
                                    </Col>
                                    <Col>
                                        <p className='mb-0 text-center' style={{fontSize: '12px'}}>{cyear_name}</p>
                                        <p className='text-center mb-0' style={{fontSize: '12px'}}>{cseason_name}</p>
                                    </Col>
                                </Row>
                            </Col>
                        </Row>
                ...
                <CardBody className='ms-1 mt-1'>
                    ...
                    <small><b>ОНА </b>- олон нийтийн ажил</small>
                </CardBody>
            </div>
        </Fragment>
    )
