...
const Teacher = () => {
    ...
    async function getDatas() {
        ...
        const { success, data } = await allFetch(
            teacherApi.getList(
                ...
                searchValue,
                school_id,
                selected_values.department_id,
                selected_values.position_id,
    ...
    async function sendExcel(data) {
        ...
        await fetchData(teacherApi.postExcel(formData));
    }
                ...
                <Row className="justify-content-between mx-0 mb-1 mt-1">
                    ...
                    <Col md={3}>
                        ...
                        <Select
                            ...
                            value={position_option.find(
                                (c) => c.id === selected_values.position_id,
                            )}
                            noOptionsMessage={() => t('Хоосон байна.')}
                            onChange={(val) => {
                                setSelectValue((current) => {
