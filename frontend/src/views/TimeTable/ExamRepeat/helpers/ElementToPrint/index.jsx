...
export default function ElementToPrint({ data_to_print, setElementToPrint }) {
						...
						<tr>
							<td align='center' className="mainTable">
								...
								<div className="etp_mt-1 text-uppercase">
									{`${data_to_print?.lesson_year} ${t('ОНЫ ХИЧЭЭЛИЙН ЖИЛИЙН')} ${data_to_print?.lesson_season == "Намар" ? 'I' : 'II'} ${t('УЛИРЛЫН')} ${t('ДАВТАН ШАЛГАЛТЫН СУРАЛЦАГЧДЫН ҮНЭЛГЭЭНИЙ ХУУДАС')}`}
								</div>
