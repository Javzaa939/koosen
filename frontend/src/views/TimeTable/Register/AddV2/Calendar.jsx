        ...
        eventMouseEnter: function(info) {
            if (info.event.extendedProps.event_id) {
                var tooltipInstance = new Popover(info.el, {
                    ...
                    content:
                    `
                        <small className='mb-0'>Төрөл: ${info.event.extendedProps.type_name}</small><br/>
                        <small className='mb-0'>Багш: ${info.event.extendedProps.teacher_name}</small><br/>
                        <small className='mb-0'>Ангиуд: ${info.event.extendedProps.group}</small><br/>
                        <small className='mb-0'>Өрөө: ${info.event.extendedProps.room ? info.event.extendedProps.room_name : ''}</small>
                    `
                });
              }
        },
