...
function RemoteLesson() {
    ...
    async function getDatas() {
        const { success, data } = await fetchData(
            remoteApi.get(rowsPerPage, currentPage, sortField, searchValue),
        );
                            ...
                            <Col sm={6} lg={3} key={idx} className="m-0 p-50">
                                <Card className="p-50 h-100 shadow-none border bg-white">
                                    <CardBody className="p-1 pt-50 d-flex flex-column h-100">
                                        {imageOriginal && (
                                            <div
                                                className="rounded-2 text-center mb-1"
                                        ...
                                        <div className="d-flex justify-content-between align-items-center mb-1">
                                            <div>
                                                ...
                                                <UncontrolledPopover
                                                    ...
                                                    target={`teacher_${idx}`}
                                                >
                                                    <PopoverHeader>Багшийн мэдээлэл</PopoverHeader>
                                                    <PopoverBody>
                                                        <div>
                                                            <div style={{ fontSize: 12 }}>
                                                                {teacher_info?.sub_org?.name}
                                                            </div>
                                                            <b>
                                            ...
                                            <div className="d-flex justify-content-between">
                                                <div className="d-flex">
                                                    <div>
                                                        ...
                                                        <UncontrolledTooltip
                                                            placement="top"
                                                            target={`complaintListDatatableEdit${id}`}
                                                        >
                                                            Засах
                                                        </UncontrolledTooltip>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <UncontrolledTooltip
                                                            placement="top"
                                                            target={`complaintListDatatableCancel${id}`}
                                                        >
                                                            Устгах
                                                        </UncontrolledTooltip>
                                                    </div>
                                                ...
                                                <Button
                                                    ...
                                                    size="sm"
                                                >
                                                    <span className="me-50">Дэлгэрэнгүй</span>{' '}
                                                    <FaAngleDoubleRight />
                                                </Button>
                                            </div>
                                        </div>
