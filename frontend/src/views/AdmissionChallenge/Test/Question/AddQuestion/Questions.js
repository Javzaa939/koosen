...
function Question(props) {
    ...
    return questions.map((rowsData, idx) => {
        ...
        const { kind, question, imageUrl, image,  rating_max_count, low_rating_word, high_rating_word, max_choice_count, choices, score, yes_or_no } = rowsData;
                                ...
                                <Col md={6} className='mt-1'>
                                    <div className="d-flex custom-flex">
                                        <div className="me-2">
                                            ...
                                            <div className="orgLogoDiv" onChange={(e) => handleChange(idx, '', e.target.name,)}>
