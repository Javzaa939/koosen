                ...
                <div className="d-flex justify-content-between mb-1">
                                    ...
                                    {nav_menus.map((menu, idx) => {
                                        return (
                                            <NavItem key={`${idy}-${idx}`}>
                                                <NavLink
                                                    active={
                                                        active == `${item?.id}-${menu.active_id}` ||
                                                        active === menu.active_id
                                                    }
                                                    onClick={() => {
                                                        toggle(menu, item);
                                                    }}
                    ...
                    <div className="mt-1 ps-2" style={{ width: '10%' }}>
                        <>
                            ...
                            <UncontrolledTooltip
                                placement="top"
                                target={`complaintListDatatableEdit${item.id}`}
                            >
                                Засах
                            </UncontrolledTooltip>
                        </>
                        <>
                            ...
                            <UncontrolledTooltip
                                placement="top"
                                target={`complaintListDatatableCancel${item.id}`}
                            >
                                Устгах
                            </UncontrolledTooltip>
                        </>
