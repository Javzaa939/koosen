...
import { Row, Col, Form, Modal, Input, Label, Button, ModalBody, ModalHeader } from "reactstrap";
...
export default function Solve({ isOpen, handleModal, datas, getDatas, unit })
{
    ...
    async function onSubmit(cdata)
    {
        ...
        const { success, error } = await fetchData(complaintApi.post(cdata, menu_id))
        if (success)
        {
            reset()
            handleModal()
