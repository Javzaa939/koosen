                            ...
                            <div className="text-center" style={{ maxWidth: 700 }}>
                                {
                                    ...
                                    ?
                                        ...
                                        :
                                            ...
                                            :
                                                `${datas?.student?.last_name} овогтой ${datas?.student?.first_name} /${datas?.student?.first_name}/ нь МҮИС-д ${datas?.student?.group?.degree?.degree_name}-н зэргийн ${datas?.student?.group?.profession?.name} мэргэжлээр ${datas?.score?.score_obj?.gpa} голч дүнтэй нь үнэн болно.`
                                    :
