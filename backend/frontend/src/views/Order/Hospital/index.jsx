...
const Hospital = () => {
    ...
    // Api
    const hospitalApi = useApi().order.hospital
    ...
    async function getDatas() {
        const { success, data } = await allFetch(hospitalApi.get(rowsPerPage, currentPage, sortField, searchValue, is_today, flag_id))
        if(success) {
    ...
    useEffect(() => {
        getDatas()
    },[rowsPerPage, currentPage, sortField, is_today, flag_id])
