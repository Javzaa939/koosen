...
def fix_sequence(apps, schema_editor):
    ...
    table_fields = ["lms_admissionlesson","lms_building","lms_country","lms_discounttype","lms_dormitorypayment","lms_dormitoryroom",
                    ...
                    "lms_lessontype","lms_paymentbalance","lms_paymentbeginbalance","lms_paymentdiscount","lms_request","lms_professionaldegree",
                    "lms_professiondefinition","lms_request_send","lms_scoreregister","lms_room","lms_stipend","lms_score","lms_season","lms_stipentstudent",
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('lms', '0068_alter_group_unique_together'),
    ]
