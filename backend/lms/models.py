...
class OnlineSubInfo(models.Model):
    ...
    # quiz = models.ForeignKey(QuezChallenge, verbose_name='Цахим сургалтын сорил шалгалт')
    is_finish = models.BooleanField(default=False, verbose_name='Хичээлийг дууссан эсэх')
