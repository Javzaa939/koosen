...
class LessonStandart(models.Model):
    ...
    skill = models.TextField(null=True, verbose_name="Олгох чадвар")
    attitude = models.TextField(null=True, verbose_name="Дадал хандлага")
...
class GraduationWork(models.Model):
    ...
    diplom_qr = models.ImageField(verbose_name='Дипломын QR', upload_to='student_qr/', null=True)
...
class Challenge(models.Model):
    ...
    group = models.ManyToManyField(Group, blank=True, verbose_name="Анги")
