...
urlpatterns = [
    ...
    path('lessonstandart/post-excel/', LessonStandartPostExcelAPIView.as_view()),
    ...
    path(
        'lessonstandart/list/profession/<int:profession>/',
        LessonStandartProfessionListAPIView.as_view(),
    ),
    ...
    path(
        'lessonstandart/timetable-list/', LessonStandartTimetableListAPIView.as_view()
    ),
    ...
    path(
        'lessonstandart/titleplan/<int:lessonID>/<int:pk>/',
        LessonTitlePlanAPIView.as_view(),
    ),
    ...
    path(
        'plan/list/<int:salbar>/<int:level>/<int:type>/<int:profession>/',
        LearningPlanListAPIView.as_view(),
    ),
    ...
    path(
        'challenge/add/student/<int:pk>/<int:student>/',
        ChallengeAddStudentAPIView.as_view(),
    ),
    ...
    path(
        'challenge/questions/difficulty_levels/',
        TestQuestionsDifficultyLevelsAPIView.as_view(),
    ),
    ...
    # admission challenge
    path('admission-challenge/details/', AdmissionChallengeDetailApiView.as_view()),
    path('challenge/add/admission-user/', ChallengeAddAdmissionUserAPIView.as_view()),
    path(
        'challenge/add/admission-user/<int:pk>/<int:student>/',
        ChallengeAddAdmissionUserAPIView.as_view(),
    ),
    path(
        'challenge/add/admission-user/addKind/<int:pk>/',
        AdmissionChallengeAddKindAPIView.as_view(),
    ),
    ...
    path(
        'psychological_test_question/title/',
        PsychologicalQuestionTitleAPIView.as_view(),
    ),
    path(
        'psychological_test_question/title/list/',
        PsychologicalQuestionTitleListAPIView.as_view(),
    ),
    path(
        'psychological_test_question/title/<int:pk>/',
        PsychologicalQuestionTitleAPIView.as_view(),
    ),
    path('psychological_test_question/', PsychologicalTestQuestionsAPIView.as_view()),
    path(
        'psychological_test_question/list/', PsychologicalTestQuestionsAPIView.as_view()
    ),
    path(
        'psychological_test_question/<int:pk>/',
        PsychologicalTestQuestionsAPIView.as_view(),
    ),
    ...
    path(
        'psychological_test/scope_option/',
        PsychologicalTestScopeOptionsAPIView.as_view(),
    ),
    path('psychological_test/scope_list/', PsychologicalTestScopesAPIView.as_view()),
    path(
        'psychological_test/add_scope/<int:pk>/',
        PsychologicalTestScopeOptionsAPIView.as_view(),
    ),
    path('psychological_test_result/', PsychologicalTestResultAPIView.as_view()),
    path(
        'psychological_test_result_participants/',
        PsychologicalTestResultParticipantsAPIView.as_view(),
    ),
    path(
        'psychological_test_result_show/', PsychologicalTestResultShowAPIView.as_view()
    ),
    path(
        'psychological_test_result_excel/',
        PsychologicalTestResultExcelAPIView.as_view(),
    ),
    path(
        'psychological_test_result_excel/by-scope/',
        PsychologicalTestResultExcelByScopeAPIView.as_view(),
    ),
    ...
    path(
        'lesson/material/assignment/<int:pk>/',
        LessonMaterialAssignmentApiView.as_view(),
    ),
    path(
        'lesson/material/send-material/<int:lesson>/',
        LessonMaterialSendApiView.as_view(),
    ),
    ...
    path(
        'lessonstandart/group/score/<int:pk>/',
        LessonStandartGroupScoreAPIView.as_view(),
    ),
