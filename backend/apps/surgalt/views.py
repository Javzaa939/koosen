...
class PsychologicalTestResultExcelByScopeAPIView(
    ...
    def get(self, request):
        ...
        for user in mental_users:
            ...
            user_data['first_name'] = user_obj.first_name
            user_data['last_name'] = user_obj.last_name
            user_data['register'] = user_obj.register_num
    ...
    def get_scope_users(scope_kind,test_id):
        ...
        if scope_kind == PsychologicalTest.SCOPE_STUDENTS:
            ...
            scope_users_qs = scope_users_qs.annotate(
                ...
                answer=F('mentalstudent__answer'),
            )
...
# answer =  "{\"27721\":105738,\"27725\":105753,\"27728\":105767,\"27731\":105779,\"27739\":105810,\"27741\":105817,\"27746\":105838,\"27748\":105845,\"27756\":105878,\"27758\":105887,\"27759\":105890,\"27762\":105902,\"27769\":105931,\"27771\":105938,\"27773\":105945,\"27776\":105956,\"27782\":105982,\"27783\":105984,\"27788\":106005,\"27797\":106042,\"27801\":106057,\"27803\":106064,\"27804\":106069,\"28084\":107126,\"28088\":107140,\"28096\":107173,\"28098\":107179,\"28100\":107188,\"28102\":107197,\"28104\":107204}"

# json_answer = json_load(answer)

# challenge_id = 944
# student_id = 4123

# challenge = ChallengeStudents.objects.filter(challenge=challenge_id, student=student_id).update(
#     answer = json_answer
# )
# print(challenge)